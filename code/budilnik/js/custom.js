...
function alarmInterval(){
	...
	$('#set_alarm_button').click(function() {
        ...
        var h1 = $("#hours_one").text();
        var h2 = $("#hours_two").text();
        var m1 = $("#minutes_one").text();
        var m2 = $("#minutes_two").text();
        var usersQuery = h1 + h2 + ":" + m1 + m2;
        
        $.post("/check.php", {usersQuery: usersQuery});
	});
